...
require (
	...
	github.com/SENERGY-Platform/smart-service-module-worker-lib v0.0.0-20240709113752-d255ce112aeb
...
require (
	...
	github.com/SENERGY-Platform/device-repository v0.0.30 // indirect
