...
require (
	...
	github.com/SENERGY-Platform/smart-service-module-worker-lib v0.0.0-20240422103401-f5406f008c53
...
require (
	...
	github.com/SENERGY-Platform/permission-search v0.0.9 // indirect
