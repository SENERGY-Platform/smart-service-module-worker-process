...
require (
	...
	github.com/SENERGY-Platform/smart-service-module-worker-lib v0.0.0-20240103105005-457686f73781
...
require (
	...
	github.com/SENERGY-Platform/device-repository v0.0.2 // indirect
