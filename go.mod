...
require (
	...
	github.com/SENERGY-Platform/smart-service-module-worker-lib v0.0.0-20240125064140-803c9162180a
...
require (
	...
	github.com/SENERGY-Platform/device-repository v0.0.5 // indirect
