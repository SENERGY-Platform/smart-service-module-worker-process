...
require (
	...
	github.com/SENERGY-Platform/smart-service-module-worker-lib v0.0.0-20240628113344-65d284a6f459
...
require (
	...
	github.com/SENERGY-Platform/device-repository v0.0.28 // indirect
