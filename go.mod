...
require (
	...
	github.com/SENERGY-Platform/smart-service-module-worker-lib v0.0.0-20231006102420-d42eead80145
...
require (
	...
	github.com/SENERGY-Platform/device-repository v0.0.0-20230920111150-c4f598711a6e // indirect
